...
object DateHelper {
    ...
    fun Long.secondsToLocalDate() = Instant.ofEpochSecond(this).atZone(ZoneId.systemDefault()).toLocalDate()

    fun Long.secondsToLocalDateTime() = Instant.ofEpochSecond(this).atZone(ZoneId.systemDefault()).toLocalDateTime()
}
